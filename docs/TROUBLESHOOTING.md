...
### How we diagnosed it
Temporary logging (since removed) recorded, per streaming IMU, the sensor's *own*
packet counter and hardware timestamp vs. the app's received count. This let us
compute packets dropped in transit:
