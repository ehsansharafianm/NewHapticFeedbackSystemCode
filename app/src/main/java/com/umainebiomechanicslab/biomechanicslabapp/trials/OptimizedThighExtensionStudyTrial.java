...
public class OptimizedThighExtensionStudyTrial extends Trial{
    ...
    public OptimizedThighExtensionStudyTrial(String trialName, String trialTimeStamp) {
    ...
    public double getLeftAverageCadence(){
        return leftAverageCadence;
    }

    public double getRightAverageCadence(){
    ...
    public String getCommaSeparatedTrialData(){
        ...
        return trialName + "," + trialTimeStamp + "," + leftPeakThighExtensions + "," + leftPeakThighAngleAverage + "," + leftHeelStrikes +
                "," + leftAverageCadence + "," + leftAverageStrideLength + "," + leftAverageSpeed + "," + rightPeakThighExtensions + "," +
                rightPeakThighAngleAverage + "," + rightHeelStrikes + "," + rightAverageCadence + "," + rightAverageStrideLength + "," + rightAverageSpeed;
