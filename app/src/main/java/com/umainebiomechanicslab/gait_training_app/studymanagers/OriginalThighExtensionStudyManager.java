...
import com.umainebiomechanicslab.gait_training_app.targetmanagers.ThighExtensionStudyOriginalTargetManager;
...
import com.umainebiomechanicslab.gait_training_app.imus.StreamingIMUWithThighAlgorithmForOriginalThighExtensionStudy;
import com.umainebiomechanicslab.gait_training_app.imus.UniversalIMU;
import com.umainebiomechanicslab.gait_training_app.userinterfaces.ExperimenterMenuUI;
...
public class OriginalThighExtensionStudyManager extends IMUManagerWithRecordingIMUs{
    ...
    public OriginalThighExtensionStudyManager(OriginalThighExtensionStudyUI thighExtensionStudyUI, ExperimenterMenuUI experimenterMenuUI, LoadingWindowUI loadingWindowUI, Context context, FileManager fileManager) {
        ...
        targetManager = new ThighExtensionStudyOriginalTargetManager(this, thighExtensionStudyUI, fileManager);
        ...
        leftThighIMU = new StreamingIMUWithThighAlgorithmForOriginalThighExtensionStudy("Left Thigh IMU", context, this, thighExtensionStudyUI, fileManager, PAYLOAD_TYPE_CUSTOM_MODE_1, targetManager);
        rightThighIMU = new StreamingIMUWithThighAlgorithmForOriginalThighExtensionStudy("Right Thigh IMU", context, this, thighExtensionStudyUI, fileManager, PAYLOAD_TYPE_CUSTOM_MODE_1, targetManager);
