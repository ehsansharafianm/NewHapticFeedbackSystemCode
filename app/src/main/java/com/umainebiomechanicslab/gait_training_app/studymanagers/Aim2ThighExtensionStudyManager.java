...
import com.umainebiomechanicslab.gait_training_app.imus.StreamingIMUWithFootDataAlgorithmForStrideCalculation;
import com.umainebiomechanicslab.gait_training_app.imus.StreamingIMUWithThighAlgorithmForAim2ThighExtensionStudy;
    ...
    public void findGateWayIP(){
        ...
        UDPListenerThread udpListenerThread = new UDPListenerThread(experimenterMenuUI, thighExtensionStudyUI, loadingWindowUI, new UDPListenerThread.onUDPReceivedListener() {
            ...
            public void onUDPReceived(int block1, int block2, int block3) {
                ...
                //Log the successful discovery
                fileManager.writeToLogFile("Gateway IP discovered: " + block1 + "." + block2 + "." + block3 + ".X");

                //Continue to the Trial Page
                loadingWindowUI.onLoadingComplete();
            }
        });
